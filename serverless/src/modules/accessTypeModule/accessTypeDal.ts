...
export const getAccessTypeCount = async (cSearchFilterQuery) => {
    try {
        ...
        const countResult = await GenAccessType.aggregate(countAggregatePipeline);
...
export const getAccessType = async (aRequestDetails, oSort, cSearchFilterQuery, iCount) => {
    ...
    const oDocuments = await GenAccessType.aggregate([
